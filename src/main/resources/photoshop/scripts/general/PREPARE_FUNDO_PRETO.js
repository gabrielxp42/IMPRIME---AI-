...
// Date: 2025-09-06T18:39:58-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Prepare Imagem (background K)
...
try {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Ajuste o nível e curva para contraste da cor preta. Use o conta-gotas para verificar "
            ],
            "'Cntn'": [
                "<boolean>",
                true
