...
// Date: 2025-09-06T18:24:00-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: DTG & DTF Index Color Realistic HL 25 LPI 
...
try {
    ...
    jamEngine.jsonPlay(
        "'Mk  '", {
            ...
            "'Nm  '": [
                "<string>",
                "Halftone Index Color 8 (DTG & DTF)"
            ],
            "'Usng'": [
                "<reference>",
                [
    ...
    jamEngine.jsonPlay(
        "'Mk  '", {
            ...
            "'Nm  '": [
                "<string>",
                "Halftone Index Color Realistic"
            ],
            "'Usng'": [
                "<reference>",
                [
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\r\rDTG & DTF Index Color Realistic v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r\rNenhuma parte deste script, manual, ou qualquer outro arquivo incluído pode ser copiado, redistribuído, vendido, compartilhado ou incluído em outro produto.\r\rObrigado!"
            ]
        },
        DialogModes.ALL
    );
