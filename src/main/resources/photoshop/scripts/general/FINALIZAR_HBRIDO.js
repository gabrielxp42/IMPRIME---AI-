...
// Date: 2025-09-06T18:28:27-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Finalizar Híbrida
...
try {
    ...
    jamEngine.jsonPlay(
        "'Mk  '", {
            ...
            "'Nm  '": [
                "<string>",
                "Halftone Retícula Híbrida (Manual)"
            ],
            "'Usng'": [
                "<reference>",
                [
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\rHalftone Retícula Híbrida v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r"
            ]
        },
        DialogModes.ALL
    );
