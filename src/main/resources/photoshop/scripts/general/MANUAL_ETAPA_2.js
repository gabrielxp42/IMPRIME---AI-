...
// Date: 2025-09-06T18:31:15-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Halftone Nocaute Color Etapa 2 v3
...
// Action “Halftone Nocaute Color 2”
try {
    // Select
    jamEngine.jsonPlay(
        "'slct'", {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Clique em OK para achatar(Flatten) a imagem.\rUse a mesma resolução do inicio e o método halftone screen.\rDefina a frequência, ângulo e formato de ponto.\rexemplo: F: 38  A: 22,5  P: Redondo"
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\rHalftone Nocaute Color v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r"
            ]
        },
        DialogModes.ALL
    );
