...
import { DocumentSettings } from '../../types/canvas-elements';
...
const NewDocumentModal: React.FC<NewDocumentModalProps> = ({
    ...
    return (
        <div className="new-doc-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="new-doc-title">
            <div className="new-doc-modal" onClick={(e) => e.stopPropagation()}>
                <div className="new-doc-header">
                    <h2 id="new-doc-title">📄 Novo Documento</h2>
                    <button className="new-doc-close" onClick={onClose} aria-label="Fechar modal">✕</button>
                </div>

                <div className="new-doc-content">
                    {/* Presets */}
                    <div className="new-doc-section">
                        <label id="presets-label">Presets:</label>
                        <div className="preset-buttons" role="radiogroup" aria-labelledby="presets-label">
                            {PRESETS.map((preset, index) => (
                                <button
                                    ...
                                    role="radio"
                                    aria-checked={selectedPreset === index}
                                >
                                    {preset.name}
                                </button>
                            ))}
                ...
                <div className="new-doc-footer">
                    ...
                    <button className="btn-create" onClick={handleConfirm} aria-label="Criar novo documento">
                        ✓ Criar Documento
                    </button>
                </div>
            </div>
