...
export class BackgroundRemovalHighPrecisionHandler {
    ...
    private getScriptPath(): string {
        ...
        // Em desenvolvimento, __dirname é dist/, então subimos para a raiz e descemos para src/main
        return path.join(app.getAppPath(), 'src/main/background_remover_highprecision.py');
    }
