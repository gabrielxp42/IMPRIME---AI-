...
// Date: 2025-09-06T18:22:13-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Color Capture v3 (Grayscale) W
...
try {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Clique em OK para achatar(Flatten) a imagem.\rUse a mesma resolução do inicio e o método halftone screen.\rDefina a frequência, ângulo e formato de ponto.\rexemplo: F: 30  A: 22,5  P: Redondo"
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Se você desejar trazer efeitos parecido com filtros.\rAjuste as cores da paletas para isso.\rLogo após, clique no botão Finalizar no painel menu Color Capture."
            ]
        },
        DialogModes.ALL
    );
