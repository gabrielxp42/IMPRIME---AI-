...
export class BackgroundRemovalManualHandler {
    ...
    constructor() {
        ...
        if (isDev) {
            ...
            this.pythonScriptPath = path.join(process.cwd(), 'src', 'main', 'modules', 'upscayl', 'scripts', 'background_remover_manual.py');

            // Fallback para dist
            if (!fs.existsSync(this.pythonScriptPath)) {
                const distPath = path.join(process.cwd(), 'dist', 'background_remover_manual.py');
            ...
            if (!fs.existsSync(this.pythonScriptPath)) {
                this.pythonScriptPath = path.join(process.resourcesPath, 'background_remover_manual.py');
            }
        }
    }
