...
// Date: 2025-09-06T18:26:14-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: DTG & DTF Index Color Realistic HL Manual
...
try {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Clique em OK para Achatar (Flatten) a layers.\rDeixe o Output o mesmo valor que o Input (ex 300 PPI)\rEm seguida, escolha a frequência, ângulo e formato da retícula."
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Ajuste as cores conforme desejado.\rLogo após, clique em finalizar no menu IndexColor."
            ]
        },
        DialogModes.ALL
    );
