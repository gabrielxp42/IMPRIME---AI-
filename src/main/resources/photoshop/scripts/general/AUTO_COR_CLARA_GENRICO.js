...
// Date: 2025-09-06T18:29:18-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Halftone Genérico Cor Clara
...
try {
    ...
    jamEngine.jsonPlay(
        "'Mk  '", {
            ...
            "'Nm  '": [
                "<string>",
                "Halftone Genérico Cores Claras"
            ],
            "'Usng'": [
                "<reference>",
                [
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\rHalftone Genérico cor clara v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r"
            ]
        },
        DialogModes.ALL
    );
