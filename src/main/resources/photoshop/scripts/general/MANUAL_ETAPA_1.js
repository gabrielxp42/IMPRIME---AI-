...
// Date: 2025-09-07T13:16:07-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Halftone Nocaute Color Etapa 1 v3
...
// Action “Halftone Nocaute Color 1”
try {
    // Stop
    jamEngine.jsonPlay(
        "'Stop'", {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Use a ferramenta Dodge(clarear) se desejar personalizar o halftone.\rExemplo: Pinte sobre áreas onde não queira retículas.\rUse os modos Shadows, Highlights ou Midtones.\r\rLogo após, continue com a segunda etapa do script.\r\r/// Atenção cuidado para não alterar mais nada, \rpara que não afete o fluxo de trabalho de maneira negativa \\\\\\\r"
            ],
            "'Cntn'": [
                "<boolean>",
                true
