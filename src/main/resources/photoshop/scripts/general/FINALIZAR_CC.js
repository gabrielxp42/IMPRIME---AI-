...
// Date: 2025-09-06T18:28:02-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Finalizar Color Capture
...
try {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\rHalftone Color Capture v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r"
            ]
        },
        DialogModes.ALL
    );
