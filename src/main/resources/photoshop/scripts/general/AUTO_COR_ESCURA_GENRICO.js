...
// Date: 2025-09-06T18:29:42-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Halftone Genérico Cor Escura
...
try {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Em seguida clique em Flatten (achatar).\rMantenha output 300 ppi - Método Halftone Screen\rEscolha a frequência, ângulo e formato da retícula\rExemplo:  F: 30; A: 22,5; Shape: Round"
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Mk  '", {
            ...
            "'Nm  '": [
                "<string>",
                "Halftone Genérico Cores Escuras"
            ],
            "'Usng'": [
                "<reference>",
                [
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\rHalftone Genérico cor escura v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r"
            ]
        },
        DialogModes.ALL
    );
