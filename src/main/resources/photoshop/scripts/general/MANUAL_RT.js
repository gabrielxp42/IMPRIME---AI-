...
// Date: 2025-09-06T18:37:48-03:00
// Contato: contato@tecdtf.com.br
//
// Action set: Halftone Roseta Manual
...
try {
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Use o conta gotas e selecione a cor desejada para eliminar."
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Ajuste os níveis para obter o meio-tom desejado.\rExemplo: Onde sua imagem estiver com a cor branca pura, ela manterá a cor sólida(original da imagem)\rOnde sua imagem estiver com tons de cinza será reticulado(meio-tom).\rOnde sua imagem estiver com a cor preta pura, ela removerá essa área da imagem.\rUse o conta gotas para ajudar medir a porcentagem de cor (Vá no menu Windows e clique em Info (F8))"
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Clique em OK para Achatar (Flatten) a Layers.\rEm seguida, deixe o Output o mesmo valor que o Input (ex 300 PPI)\rDefina a frequência, ângulo e formato de retícula para o primeiro halftone.\rExemplo: F: 30; A: 15; Formato da Retícula: Round."
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Clique em OK para Achatar (Flatten) a Layers.\rEm seguida, deixe o Output o mesmo valor que o Input (ex 300 PPI)\rDefina a frequência, ângulo e formato de retícula para o segundo halftone.\rExemplo: F: 30; A: 75; Formato da Retícula: Round."
            ],
            "'Cntn'": [
                "<boolean>",
                true
    ...
    jamEngine.jsonPlay(
        "'Stop'", {
            "'Msge'": [
                "<string>",
                "Script Concluído!\r\rHalftone Roseta Manual v3.0 ©2025 TEC-DTF - RIO DE JANEIRO - Todos o direitos reservados Lei 9.610 (BR).\r"
            ]
        },
        DialogModes.ALL
    );
